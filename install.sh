...
cd ODR-DabMux/
./bootstrap.sh
./configure --enable-input-zeromq --enable-output-zeromq --enable-output-raw --enable-input-prbs --enable-input-test --enable-input-slip --enable-input-udp --enable-output-edi
make
make install
